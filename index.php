<?php include_once('inc/movie_header.php'); ?>
  <div class="s006">
...
<?php  if($Movie_Grp_comingsoon == 1 ){ ?>
  <h2 class="latest">Recently added movies</h2>
  <div class="container">
    <div class="result">
      <div class="card-deck">
        <?php
          $str = file_get_contents('https://api.themoviedb.org/3/movie/upcoming?api_key='.$Movie_Grp_ImdbApi);
