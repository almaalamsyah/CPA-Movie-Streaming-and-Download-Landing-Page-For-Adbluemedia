<?php
    $movieid = $_GET['id'];
    include_once('inc/movie_header.php');
    if (!empty($movieid)) {
    $str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'?api_key='.$Movie_Grp_ImdbApi);
...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="tmdbdescript">
                    ...
                    <?php
                    $desc = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/translations?api_key='.$Movie_Grp_ImdbApi);
  ...
  <?php  if($Movie_Grp_related == 1 ){ ?>
    <div class="breakspace"></div>
        <?php 
            $str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/similar?api_key='.$Movie_Grp_ImdbApi);
            $json = json_decode($str, true);
    ...
    <div class="spaces" ></div>
    <?php
        $str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/videos?api_key='.$Movie_Grp_ImdbApi);
        $json = json_decode($str, true);
    ?>
  ...
  <script type="text/javascript"> var CPABUILDSETTINGS={"it":"<?php echo $Movie_Grp_adbluemedia_it ; ?>","key":"<?php echo $Movie_Grp_adbluemedia_key ; ?>"};</script>
